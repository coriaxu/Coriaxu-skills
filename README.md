...
感谢以下开源作者的 skill，没有他们就没有这个仓库的完整形态：花叔（nuwa-skill、darwin-skill）、LearnPrompt（luban-skill）、小能熊老师（三级笔记）、姚金刚（yao-meta-skill）、dontbesilent（dbs 系列）、Obsidian（obsidian-markdown、obsidian-bases）、乔木（qiaomu-epub-book-generator）、akira82-ai（agent-review）、一泽 Eze（web-access）、MrGeDiao（shuorenhua）、卡兹克（aihot）。
