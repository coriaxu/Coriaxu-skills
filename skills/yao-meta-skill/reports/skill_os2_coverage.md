...
- status: `covered`
- existing evidence: `scripts/render_daily_skillops_report.py`, `tests/verify_daily_skillops.py`, `reports/skillops/daily/2026-06-22.json`, `reports/skillops/daily/2026-06-22.md`
...
- status: `covered`
- existing evidence: `scripts/render_weekly_curator_report.py`, `tests/verify_weekly_curator.py`, `reports/skillops/weekly/2026-W26.json`, `reports/skillops/weekly/2026-W26.md`
